...
<div class="container">
    <h2 class="shop1">Shopping Checkout</span></h2>
    <div class="col-12">
        <div class="checkout">
            <div class="row">
                ...
                <div class="col-md-4 order-md-2 mb-4">
                    ...
                    <a href="menu.php" class="btn btn-block btn-info">Add Items</a>
                </div>
                <div class="col-md-8 order-md-1">
                    ...
                    <form method="post" action="cartAction.php" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="phone_number" value="<?php echo !empty($postData['phone_number'])?$postData['phone_number']:''; ?>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <input type="submit" class="btn btn-primary" type="submit" name="checkoutSubmit" value="Place Order">
